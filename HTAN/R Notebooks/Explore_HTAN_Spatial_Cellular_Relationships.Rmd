...
As an example we identify the 10 nearest neighbhors for each cell. As the pairwise distance calculation is resource intenstive for the entire collection of 1.2 million cells, we limit the illustration to square of 2500 pixels each side, or `r 2500*0.65` micrometers per side.
...
There are `r nrow(df_small)` cells within this region. 

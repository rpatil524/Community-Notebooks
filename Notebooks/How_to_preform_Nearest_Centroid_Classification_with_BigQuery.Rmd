...
Author:  Lauren Hagen
Created: 2019-12-17
URL:     https://github.com/isb-cgc/Community-Notebooks/blob/master/Notebooks/How_to_preform_Nearest_Centroid_Classification_with_BigQuery.Rmd
...
We will be attempting to predict the clinical stage for a case based on a certain subset of genes and their expression levels.

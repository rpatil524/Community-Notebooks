...
This Quick Start Guide gives an overview of the data available, account set-up overview, and getting started with a basic example in R. If you have read the python version, you can skip to the Example section.
...
This notebook requires the bigrquery package to be loaded [(click here for more information)](https://cran.r-project.org/web/packages/bigrquery/index.html). This library will allow you to access BigQuery programmatically.
...
*Note: this will come up with your first call to BigQuery and will be cached*
...
[Alternative authentication methods](https://bigrquery.r-dbi.org/reference/bq_auth.html)
